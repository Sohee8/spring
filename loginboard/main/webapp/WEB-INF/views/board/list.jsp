...
<thead>
<tr><th>번호</th><th>제목</th><th>작성자</th><th>주소</th><th>등록일</th></tr>
</thead>
...
<td>
<a href="/board/readView?bno=${list.bno}&page=${scri.page}&perPageNum=${scri.perPageNum}&seachType=${scri.searchType}&keyword=${scri.keyword}"><c:out value="${list.title}" /></a>
</td>
